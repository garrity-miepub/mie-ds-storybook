import{ar as V,as as P,a0 as Y}from"./store-DKrw96s8.js";import{p as z}from"./props-WZpD2vyg.js";import{h as E}from"./html-BjPEsh1c.js";function d(e,t){let c=z(t,"content",8,"");var a=V(),p=P(a);E(p,c),Y(e,a)}d.__docgen={version:3,name:"AlertDialogContent.svelte",data:[{name:"content",visibility:"public",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:'""'}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const g=({title:e="Default Title",content:t="This is the default alert dialog content.",type:c="Default",icon:a=null})=>`
...
}`,...($=(W=l.parameters)==null?void 0:W.docs)==null?void 0:$.source}}};const F=["Default","Informative","Warning","Danger","Success","Interactive"];export{s as Danger,n as Default,r as Informative,l as Interactive,i as Success,o as Warning,F as __namedExportsOrder,R as default};
