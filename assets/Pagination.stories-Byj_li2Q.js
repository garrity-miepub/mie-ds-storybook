import{ar as C,as as y,a0 as T}from"./store-DKrw96s8.js";import{p as x}from"./props-WZpD2vyg.js";import{h as S}from"./html-BjPEsh1c.js";const d=({currentPage:e=1,totalPages:n=10,...c})=>{let a;const p=()=>{e>1&&(e-=1,s())},b=()=>{e<n&&(e+=1,s())},P=t=>{e=t,s()},k=(t,o)=>Array.from({length:o-t+1},(H,$)=>t+$),s=()=>{if(a||(a=document.getElementById("pagination")),!a)return;const t=k(1,n);a.innerHTML=`
         <ul class="pagination">
