import{as as D,at as L,$ as M}from"./store-T5UnPX9g.js";import{p as x}from"./props-C9IDeoNK.js";import{h as $}from"./html-BUZpgOoR.js";const t=({isOpen:e=!1,title:o="",content:d="",triggerText:r="Open Dialog",showHeader:c=!0,showFooter:H=!0})=>`
    <div data-is-open="${e}" >
        ${e?`
...
}`,...(m=(g=a.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var u,f,h;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createDialogHTML(args)
...
}`,...(h=(f=s.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var v,T,y;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createDialogHTML(args)
...
}`,...(y=(T=i.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};var _,b,C;l.parameters={...l.parameters,docs:{...(_=l.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createDialogHTML(args)
...
}`,...(C=(b=l.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};const N=["Default","OpenDialog","NoHeader","NoFooter"];export{a as Default,l as NoFooter,i as NoHeader,s as OpenDialog,N as __namedExportsOrder,F as default};
