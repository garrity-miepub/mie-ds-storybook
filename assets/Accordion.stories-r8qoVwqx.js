import{p as I,a0 as p,e as M,a1 as S,a2 as v}from"./store-DIQEHCOu.js";import{p as b}from"./props-DO17Jqv7.js";import{i as _}from"./if-DGZZ-pQQ.js";import{h as w}from"./html-Dgl4xvzF.js";import{i as q}from"./lifecycle-9Sjl64q2.js";import{o as H}from"./index-client-BsC9Mbj1.js";var T=S("<div><!></div>"),z=S("<div><!></div>");function f(c,e){I(e,!1);let r=b(e,"content",8,""),n=b(e,"onCreated",8,()=>{});H(()=>{const t=document.querySelector(".ds-accordion");n()(t)}),q();var a=z(),i=v(a);{var o=t=>{var d=T(),s=v(d);w(s,r),p(t,d)};_(i,t=>{r()&&t(o)})}p(c,a),M()}f.__docgen={version:3,name:"AccordionContent.svelte",data:[{name:"content",visibility:"public",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:'""'},{name:"onCreated",visibility:"public",keywords:[],kind:"let",type:{kind:"function",text:"() => void"},static:!1,readonly:!1,defaultValue:"function"}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const g=({items:c,size:e="default"})=>{const r=["ds-accordion"];e==="condensed"&&r.push("condensed");const n=c.map((i,o)=>`
    <div class="item">
...
}`,...(x=(C=m.parameters)==null?void 0:C.docs)==null?void 0:x.source}}};const J=["Default","Condensed"];export{m as Condensed,u as Default,J as __namedExportsOrder,G as default};
