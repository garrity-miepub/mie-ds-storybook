import{ar as A,as as V,a0 as j}from"./store-DKrw96s8.js";import{p as B}from"./props-WZpD2vyg.js";import{h as F}from"./html-BjPEsh1c.js";const y=({items:n=[],bookmarks:c=!1,fullUrls:g=!0,profileRadioValue:l="benoit",openMenuIndex:a=null,openSubmenuIndex:o={},...H})=>{let i;const b=e=>{a=a===e?null:e,u()},f=(e,t)=>{o[e]||(o[e]={}),o[e][t]=o[e][t]?null:!0,u()},R=(e,t,r=null)=>{if(e.key==="Escape"){a=null,r!=null&&(o[t][r]=null),u();return}(e.key==="Enter"||e.key===" ")&&(r==null?b(t):f(t,r))},S=e=>{var t,r;return e.type==="separator"?'<div class="menubar__separator"></div>':e.type==="sub"?`
                    <button
