import{ar as B,as as N,a0 as k}from"./store-DIQEHCOu.js";import{p as R}from"./props-DO17Jqv7.js";import{h as E}from"./html-Dgl4xvzF.js";const r=({isOpen:e=!1,title:n="",placement:i="bottom",showHeader:o=!0,showCloseButton:m=!0,triggerText:S="Open Drawer",content:V=""})=>{const P=`ds-drawer ds-drawer--${i}`;return`
        <div data-is-open="${e}">
            <button>${S}</button>
            ${e?`
