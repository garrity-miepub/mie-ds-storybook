import{Y as _,a8 as C,a9 as H,a1 as M}from"./props-D-11tLXy.js";import{h as $}from"./html-DH_r2Hsk.js";const l=({items:e=[{label:"Home",href:"/"},{label:"Products",href:"/products"},{label:"Details",href:"/products/details"}]})=>{let a='<nav aria-label="Breadcrumb"><ol class="ds-breadcrumb">';return e.length<=3?e.forEach((r,t)=>{a+=`
...
}`,...(u=(p=s.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};var b,i,m;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createBreadcrumbHTML(args)
...
}`,...(m=(i=n.parameters)==null?void 0:i.docs)==null?void 0:m.source}}};var f,h,g;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createBreadcrumbHTML(args)
...
}`,...(g=(h=o.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const T=["Default","WithMoreItems","WithEvenMoreItems"];export{s as Default,o as WithEvenMoreItems,n as WithMoreItems,T as __namedExportsOrder,P as default};
