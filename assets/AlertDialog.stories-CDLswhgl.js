import{as as V,at as P,$ as Y}from"./store-T5UnPX9g.js";import{p as z}from"./props-C9IDeoNK.js";import{h as E}from"./html-BUZpgOoR.js";function d(e,t){let c=z(t,"content",8,"");var a=V(),p=P(a);E(p,c),Y(e,a)}d.__docgen={version:3,name:"AlertDialogContent.svelte",data:[{name:"content",visibility:"public",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:'""'}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const g=({title:e="Default Title",content:t="This is the default alert dialog content.",type:c="Default",icon:a=null})=>`
