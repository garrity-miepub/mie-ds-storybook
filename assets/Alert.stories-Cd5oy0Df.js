import{ar as q,as as P,a0 as S}from"./store-DKrw96s8.js";import{p as I}from"./props-WZpD2vyg.js";import{h as $}from"./html-BjPEsh1c.js";function l(e,n){let o=I(n,"content",8,"");var i=q(),c=P(i);$(c,o),S(e,i)}l.__docgen={version:3,name:"AlertContent.svelte",data:[{name:"content",visibility:"public",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:'""'}],computed:[],methods:[],components:[],description:null,keywords:[],events:[],slots:[],refs:[]};const m=({type:e="informative",icon:n="fa-info-circle",heading:o="Informative Alert",content:i="This is an informative alert.",link:c="Learn more",linkPath:T="#"})=>`
...
}`,...(b=(A=s.parameters)==null?void 0:A.docs)==null?void 0:b.source}}};const L=["Informative","Warning","Success","Danger"];export{s as Danger,a as Informative,r as Success,t as Warning,L as __namedExportsOrder,_ as default};
