import{ar as H,as as M,a0 as V}from"./store-DIQEHCOu.js";import{p as $}from"./props-DO17Jqv7.js";import{h as k}from"./html-Dgl4xvzF.js";const s=({frameworks:e=[{value:"sveltekit",label:"SvelteKit"},{value:"next.js",label:"Next.js"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],placeholder:n="Select a framework...",open:r=!1,value:o="",inputValue:a=""})=>{var m;const S=((m=e.find(t=>t.value===o))==null?void 0:m.label)??n,d=e.filter(t=>t.label.toLowerCase().includes(a.toLowerCase()));return`
    <div class="combobox" data-open="${r}" data-value="${o}" data-input-value="${a}">
        <button
            type="button"
...
}`,...(w=(L=u.parameters)==null?void 0:L.docs)==null?void 0:w.source}}};const A=["Default","Open","WithSelectedValue","WithInputValue"];export{c as Default,p as Open,u as WithInputValue,i as WithSelectedValue,A as __namedExportsOrder,R as default};
