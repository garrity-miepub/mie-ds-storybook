...
}`,...(N=(G=u.parameters)==null?void 0:G.docs)==null?void 0:N.source}}};var Y,j,q;f.parameters={...f.parameters,docs:{...(Y=f.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createBadgeHTML(args)
...
}`,...(q=(j=f.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};const te=["Default","Primary","Secondary","Success","Warning","Danger","Outlined","LeadingIcon","TrailingIcon","WithBothIcons"];export{g as Danger,s as Default,m as LeadingIcon,i as Outlined,c as Primary,d as Secondary,l as Success,u as TrailingIcon,p as Warning,f as WithBothIcons,te as __namedExportsOrder,oe as default};
