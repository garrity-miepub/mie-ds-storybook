import{as as C,at as y,$ as T}from"./store-T5UnPX9g.js";import{p as x}from"./props-C9IDeoNK.js";import{h as S}from"./html-BUZpgOoR.js";const d=({currentPage:e=1,totalPages:n=10,...c})=>{let a;const p=()=>{e>1&&(e-=1,s())},b=()=>{e<n&&(e+=1,s())},P=t=>{e=t,s()},k=(t,o)=>Array.from({length:o-t+1},(H,$)=>t+$),s=()=>{if(a||(a=document.getElementById("pagination")),!a)return;const t=k(1,n);a.innerHTML=`
