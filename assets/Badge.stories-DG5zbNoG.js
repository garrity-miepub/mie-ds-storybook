import{as as X,at as Y,$ as Z}from"./store-T5UnPX9g.js";import{p as ee}from"./props-C9IDeoNK.js";import{h as ne}from"./html-BUZpgOoR.js";const n=({filled:e=!0,type:r="default",leadingIcon:t=null,trailingIcon:o=null,label:b="Badge"})=>{const K=`ds-badge--${r}`,Q=e?"ds-badge--filled":"ds-badge--outlined",y=U=>`<i class="fas ${U}"></i>`;return`
