import{ar as G,as as J,a0 as Q}from"./store-DIQEHCOu.js";import{p as R}from"./props-DO17Jqv7.js";import{h as Y}from"./html-Dgl4xvzF.js";const n=({media:e=null,showMedia:o=!0,primaryTitle:a="",showPrimaryTitle:r=!0,secondaryTitle:s="",showSecondaryTitle:T=!0,supportingText:h="",showSupportingText:f=!0,actions:C=null,showActions:q=!0,leadingUtilityIcon:l="none",utilityHeader:w="",utilityContent:x="",utilityIcons:O=[],showUtility:j=!0})=>{const c={user:'<i class="fa fa-user"></i>',check:'<i class="fa fa-check-circle"></i>',warning:'<i class="fa fa-exclamation-triangle"></i>'},B=r&&a||T&&s||f&&h;let t='<div class="ds-card">';return o&&e&&(t+=`<div class="media">${e}</div>`),B&&(t+='<div class="content">',r&&a&&(t+=`<h3 class="primary-title">${a}</h3>`),T&&s&&(t+=`<h4 class="secondary-title">${s}</h4>`),f&&h&&(t+=`<p class="supporting-text">${h}</p>`),t+="</div>"),j&&(t+='<div class="utility">',l!=="none"&&c[l]&&(t+=`
            <button type="button" class="mie button tertiary icon-only" aria-label="Utility icon for ${l}">
...
}`,...(W=(P=g.parameters)==null?void 0:P.docs)==null?void 0:W.source}}};var z,D,_;m.parameters={...m.parameters,docs:{...(z=m.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => ({
    Component: HTMLContent,
    props: {
      content: createCardHTML(args)
...
}`,...(_=(D=m.parameters)==null?void 0:D.docs)==null?void 0:_.source}}};const tt=["Default","WithMedia","WithActions","WithUtility","WithTrailingUtilityIcons","FullCard"];export{u as Default,m as FullCard,p as WithActions,d as WithMedia,g as WithTrailingUtilityIcons,y as WithUtility,tt as __namedExportsOrder,Z as default};
