...
})`,...(N=(G=u.parameters)==null?void 0:G.docs)==null?void 0:N.source},description:{story:"Default Breadcrumb (3 Levels)",...(F=(q=u.parameters)==null?void 0:q.docs)==null?void 0:F.description}}};var J,K,M,Q,U;f.parameters={...f.parameters,docs:{...(J=f.parameters)==null?void 0:J.docs,source:{originalSource:`({
  items
}) => ({
  Component: Breadcrumb,
  props: {
...
})`,...(M=(K=f.parameters)==null?void 0:K.docs)==null?void 0:M.source},description:{story:"Long Breadcrumb with Collapse",...(U=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:U.description}}};var W,Y,Z,$,ee;b.parameters={...b.parameters,docs:{...(W=b.parameters)==null?void 0:W.docs,source:{originalSource:`({
  items
}) => ({
  Component: Breadcrumb,
  props: {
...
})`,...(Z=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:Z.source},description:{story:"Interactive Breadcrumb",...(ee=($=b.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};const Oe=["Default","LongBreadcrumb","Interactive"];export{u as Default,b as Interactive,f as LongBreadcrumb,Oe as __namedExportsOrder,Ee as default};
